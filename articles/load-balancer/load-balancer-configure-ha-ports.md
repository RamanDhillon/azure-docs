...
To participate in the Preview of the HA ports feature in Load Balancer Standard, register your subscription for [Load Balancer Standard preview](https://aka.ms/lbpreview#preview-sign-up).

>[!NOTE]
>Registration of the Load Balancer Standard previews may take up to an hour.
