...
To participate in the preview of the HA ports feature in Load Balancer Standard, register your subscription for [Load Balancer Standard SKU](https://aka.ms/lbpreview#preview-sign-up). 

>[!NOTE]
>Registration for [Load Balancer Standard SKU](https://aka.ms/lbpreview#preview-sign-up) can take up to an hour.
